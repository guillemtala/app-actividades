            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 50vh;">
                    ...
                    if(isset($_SESSION["email_usu"])){
                        echo "<a class='nav-link active disabled' aria-current='page' href='./mis-actividades.html'>Mis actividades</a>";
                    }else{
                        echo "<a class='nav-link active disabled' aria-current='page' href='./actividades.php'>Actividades</a>";
                    } 
                    ?> 
                    </li>
                    <!-- <li class="nav-item">
                        <a class="nav-link" href="./mis-actividades.html">Sobre nosotros</a>
                    </li> -->

                    <!-- <li class="nav-item">
                        <a class="nav-link active disabled" aria-current="page" href="./mis-actividades.html">Mis actividades</a>
                    </li> -->
                </ul>
                <form class="d-flex">
